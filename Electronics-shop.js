...
// Given price lists for keyboards and USB drives and a budget, find the cost to buy them. If it is not possible to buy both
// items, return -1.
...
function getMoneySpent(keyboards, drives, b) {
  ...
  for( let i =0; i <= keyboards.length; i++) {
      for( let j = 0; j <= drives.length; j++){ls
