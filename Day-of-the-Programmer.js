...
// calendar system. The transition from the Julian to Gregorian calendar system occurred in 1918, when the next 
// day after January 31st was February 14th. This means that in 1918, February 14th was the 32nd day of the year 
// in Russia.

// In both calendar systems, February is the only month with a variable amount of days; it has 29 days during
// a leap year, and 28 days during all other years. In the Julian calendar, leap years are divisible by 4; in 
...
// Complete the dayOfProgrammer function in the editor below. It should return a string representing the date 
// of the 256th day of the year given.
...
// Print the full date of Day of the Programmer during year y in the format dd.mm.yyyy, where dd is the two-digit
