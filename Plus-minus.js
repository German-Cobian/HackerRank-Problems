...
// the decimal value of each fraction on a new line with 6 places after the decimal.
...
function plusMinus(arr) {
   ...
   let ratioPos = countPos/denom;
   let ratioNeg = countNeg/denom;
   let ratioZ = countZ/denom;
