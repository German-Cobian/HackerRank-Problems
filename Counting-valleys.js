...
// The hiker first enters a valley 2 units deep. Then they climb out and up onto a mountain 2 units high. Finally, the hiker 
...
function countingValleys(n, s) {
  ...
  for (let i = 0; i < n; i++) {
      ...
      if (str[i] === "U" && altitude === 0) {valley++;}
      if (str[i] === "D" && altitude === 0) {hill++;}
  }
  return valley;
}